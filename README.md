...
More information about the archiving project can be found on the ArchiveTeam wiki: [Viddler](http://archiveteam.org/index.php?title=Viddler)
...
Follow the [instructions on the ArchiveTeam wiki](http://archiveteam.org/index.php?title=Warrior) for installing the Warrior, and select the "Viddler" project in the Warrior interface.
...
**This project requires pyamf and pycrypto.**

### For Debian/Ubuntu:

    adduser --system --group --shell /bin/bash archiveteam
    apt-get install -y git-core libgnutls-dev lua5.1 liblua5.1-0 liblua5.1-0-dev screen python-dev python-pip bzip2 zlib1g-dev python-crypto
    pip install seesaw pyamf
    su -c "cd /home/archiveteam; git clone https://github.com/ArchiveTeam/viddler-grab.git; cd viddler-grab; ./get-wget-lua.sh" archiveteam
    screen su -c "cd /home/archiveteam/viddler-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam
    [... ctrl+A D to detach ...]
...
Ensure that you have the CentOS equivalent of bzip2 installed as well. You might need the EPEL repository to be enabled.
    ...
    yum -y install gnutls-devel lua-devel python-pip zlib-devel python-crypto
    pip install seesaw pyamf
    [... pretty much the same as above ...]

### For openSUSE:

    zypper install liblua5_1 lua51 lua51-devel screen python-pip libgnutls-devel bzip2 python-devel gcc make python-crypto
    pip install seesaw pyamf
    [... pretty much the same as above ...]
...
You need Homebrew. Ensure that you have the OS X equivalent of bzip2 installed as well.
    ...
    pip install seesaw pycrypto pyamf
    [... pretty much the same as above ...]

**There is a known issue with some packaged versions of rsync. If you get errors during the upload stage, viddler-grab will not work with your rsync version.**
...
6. `screen su -c "cd /home/archiveteam/viddler-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam`
...
Have an issue not listed here? Join us on IRC and ask! We can be found at irc.efnet.org #fiddler.
